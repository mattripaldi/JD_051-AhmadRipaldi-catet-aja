...
export default function NewOutcome({ transactions: initialTransactions, filters, stats, currencyBreakdown }) {
        ...
        <MobileLayout>
                ...
                <div className="relative pb-20">
                    {filteredTransactions.length > 0 ? (
                                                    ...
                                                    <div>
                                                        <DropdownMenu>
                                                            ...
                                                            <DropdownMenuContent align="end" className="w-48">
                                                                <ModalLink href={`/account/${auth.account.id}/outcome/${transaction.id}/edit`}>
                                                                    <DropdownMenuItem className="cursor-pointer">
                                                                        <Edit size={16} className="mr-2 text-blue-600" />
                                                                        Edit
                                                                    </DropdownMenuItem>
                                                                </ModalLink>
                                                                <ModalLink href={`/account/${auth.account.id}/outcome/${transaction.id}/delete`}>
                        ...
                        <div className="relative bg-white p-8 text-center">
                            ...
                            <h3 className="mb-2 text-lg font-semibold text-gray-900">Belum ada pengeluaran</h3>
                            <p className="text-gray-500">Mulai catat pengeluaran Anda untuk melacak keuangan dengan lebih baik</p>
            ...
            <div className="fixed bottom-36 right-1/2 transform translate-x-1/2 max-w-[480px] w-full">
                <div className="absolute right-4">
                    <ModalLink
                        href={`/account/${auth.account.id}/outcome/create`}
                        className="flex h-14 w-14 items-center justify-center rounded-full bg-red-600 text-white shadow-lg transition-all hover:bg-red-700 hover:shadow-xl active:scale-95"
                    >
